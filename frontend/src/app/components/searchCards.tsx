  ...
  <div className="" style={{display:"flex",flexWrap:"wrap"}}>
    ...
    <div className="" style={{flex:"1 1 200px"}}>
      <div className="card-body" style={{padding:"8px"}}>
        <h5 className="card-title" style={{margin:"0",fontSize:"16px",fontWeight:"500",whiteSpace: "nowrap",overflow: "hidden",textOverflow: "ellipsis",width: "15rem"}}>{props.product.title}</h5>
