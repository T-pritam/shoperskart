...
import '../../../../static/css/skeletonsearch.css'
...
const Skeleton = () => (
    <div>
        <div className='skeleton-searchResult homeSkeletonSearch_optiona' style={{backgroundColor:"white"}}>
            {
                renderSkeletons()
            }
        </div>
    <div className='skeleton-searchResult homeSkeletonSearch_optionb'>
            {
                renderSkeletonsmob()
            }
        </div>
